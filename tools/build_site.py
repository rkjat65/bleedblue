...
from broadcasts import load_broadcasts, homepage_watch, watch_page
...
def page(path,title,description,body,kind='WebPage',extra=None,noindex=False):
    ...
    nav=[('/matches/','Matches'),('/players/','Players'),('/teams/','Teams'),('/records/','Records'),('/compare/','Compare'),('/studio/','Studio'),('/series/','Series'),('/where-to-watch/','Watch')]
